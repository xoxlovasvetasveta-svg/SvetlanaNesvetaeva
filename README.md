...
Разработать ПМИ и руководство пользователя для сайта

Задача была разработать программу и методику испытаний, а также руководство пользователя для сайта бронирования капсульных отелей "Капсула"
Что сделано:
